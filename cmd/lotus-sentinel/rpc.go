...
func MetricsSentinelAPI(a api2.SentinelNode) api2.SentinelNode {
	var out api2.SentinelNodeStruct
...
func serveRPC(a api2.SentinelNode, stop node.StopFunc, addr multiaddr.Multiaddr, shutdownCh <-chan struct{}, maxRequestSize int64) error {
