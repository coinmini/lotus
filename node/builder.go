...
func Repo(r repo.Repo) Option {
	return func(settings *Settings) error {
		...
		return Options(
			...
			Override(new(dtypes.ColdBlockstore), modules.ColdBlockstore),
			...
			If(!cfg.Splitstore,
				...
				Override(new(dtypes.BaseBlockstore), From(new(dtypes.ColdBlockstore))),
				Override(new(dtypes.ExposedBlockstore), From(new(dtypes.ColdBlockstore))),
			),
